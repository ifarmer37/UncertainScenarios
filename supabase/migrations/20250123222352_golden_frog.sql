/*
  ...
  1. Changes
    - Simplify game_players policies to avoid circular references
    - Remove complex joins that could cause recursion
    - Maintain security while ensuring performance

  2. Security
    - Maintain row-level security
    - Keep authentication requirements
    - Preserve data access control
*/
...
-- Recreate policies for game_players with simplified logic
